...
INSERT INTO recipe_ingredients (recipe_id, name, quantity, measurement_type) VALUES 
...
INSERT INTO recipe_steps (recipe_id, step_number, step_directions) VALUES 
...
select * from recipes as r join recipe_ingredients on r.id=recipe_ingredients.recipe_id join recipe_steps on r.id=recipe_steps.recipe_id;